  ...
  <body>
    <nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse fixed-top">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        ...
        <li><a href="phptraining/form-validation.php">Form validation</a></li>
     <li> <a href="blogpost/index.php">blogpost </a></li>
     <li><a href="photogallery/index.php"> Photo gallery </a></li>
     <li><a href="lightbox/index.php"> lightbox </a></li>
     <li><a href="social_network/index.php"> socialpost </a></li>
     <li><a href="mar_respdesign/index.php.php">  responsive design </a>
        </ul>
